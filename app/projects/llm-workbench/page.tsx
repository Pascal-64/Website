...
const FEATURES = [
  {
    title: "Multi-Runner-Architektur",
    body: "Vier Runner-Typen in einem System: OllamaRunner für LLM-Agentic-Loops, ShellRunner für Prozesse und Build-Kommandos, AgentCliRunner für Claude Code und Codex, ReviewLoopRunner für iterative Ollama-Reviewer-Pipelines.",
  },
  {
    title: "Live-Logs & SSE-Streaming",
    body: "Alle Runs streamen stdout und stderr in Echtzeit per Server-Sent Events ins Frontend. Cancel-Button bricht laufende Prozesse ab. Status-Badges zeigen den aktuellen Zustand — von 'running' bis 'needs_review'.",
  },
  {
    title: "Git-Diff & Review-Workflow",
    body: "Nach jedem schreibenden Run wechselt der Status zu 'needs_review'. Der farbige Unified-Diff zeigt genau welche Dateien geändert wurden. Accept übernimmt die Änderungen, Reject setzt via git restore zurück — kein automatischer Commit.",
  },
  {
    title: "Scheduler & Wiki-Pipeline",
    body: "Wiederkehrende Routinen starten Runs automatisch nach Intervall und Uhrzeit. Die 4-Stufen-Wiki-Pipeline befüllt automatisch Wissenslücken: Claim → Recherche → Schreiben → Review — jede Stufe eine eigene Micro-Routine.",
  },
];
...
const RUNNER_TYPES = [
  {
    name: "OllamaRunner",
    desc: "Agentic Loop mit Tool-Calling (max. 20 Iterationen). Tools: run_shell_command, write_file, read_file, web_search, append_under_heading.",
    color: "var(--color-primary)",
    borderColor: "var(--color-primary)",
  },
  {
    name: "ShellRunner",
    desc: "Führt Shell-Befehle im Projektverzeichnis aus. Stdout/Stderr live gestreamt, Exit-Code gespeichert, Timeout erzwungen.",
    color: "var(--color-tertiary)",
    borderColor: "var(--color-tertiary)",
  },
  {
    name: "AgentCliRunner",
    desc: "Für externe Coding-Agenten (Claude Code, Codex). Status nach Lauf: 'needs_review' — Änderungen immer über Git-Diff prüfbar.",
    color: "var(--color-secondary)",
    borderColor: "var(--color-secondary)",
  },
  {
    name: "ReviewLoopRunner",
    desc: "Kombiniert Ollama-Generierung mit Reviewer-CLI. Schleife bis approved oder max_iterations — automatisches Feedback-Incorporate.",
    color: "var(--color-primary)",
    borderColor: "var(--color-primary)",
  },
];
...
const TECH = [
  "Next.js", "FastAPI", "Python", "PostgreSQL", "SQLAlchemy",
  "SSE", "Ollama", "React", "TypeScript", "Tailwind CSS", "shadcn/ui",
];

export default function LlmWorkbenchPage() {
  return (
    <>
      <TopNavBar />
        ...
        <section className="px-10 pt-48 pb-20">
          <div className="max-w-screen-xl mx-auto">
            ...
            <p className="animate-fade-up-2 text-lg text-on-surface-variant max-w-2xl leading-relaxed">
              Private Web-Oberfläche für lokale LLM- und Coding-Agent-Workflows.
              Ein kontrolliertes Workflow-Orchestrator für Ollama-Hosts, Projektkontext, Live-Logs,
              Git-Diffs und Agent-CLIs wie Claude Code oder Codex.
            </p>
          ...
          <div className="max-w-screen-xl mx-auto">
            ...
            <AnimatedSection delay={80} className="bg-surface-container-low border-l-2 border-primary/40 p-2">
              <div className="relative w-full overflow-hidden rounded-sm">
                <Image
                  src="/LLMWorkbenchPreview.png"
                  alt="LLM Workbench Preview"
                  width={1920}
                  height={1080}
        ...
        <section className="px-10 pb-32">
          <div className="max-w-screen-xl mx-auto">
            <AnimatedSection className="flex items-baseline justify-between mb-10">
              ...
              <span className="font-mono text-[10px] tracking-widest text-on-surface-variant/50 uppercase">
                {RUNNER_TYPES.length} runner types
              </span>
            </AnimatedSection>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
              {RUNNER_TYPES.map((r, i) => (
                <AnimatedSection
                  key={r.name}
                  delay={i * 80}
                >
                  <div
                    className="p-8 bg-surface-container-low hover:bg-surface-container hover:-translate-y-[2px] transition-all cursor-default"
                    style={{ borderLeft: `2px solid ${r.borderColor}40` }}
                  >
                    <h3 className="font-mono text-sm font-bold mb-3" style={{ color: r.color }}>
                      {r.name}
                    </h3>
