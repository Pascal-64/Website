      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
          {PROJECTS.map((project) => (
            <div
              key={project.title}
              className="group bg-surface-container-low p-10 hover:bg-surface-container-high transition-all"
            >
              ...
              <button className="text-secondary font-headline font-bold text-xs tracking-widest uppercase hover:underline">
                Details_
              </button>
            </div>
          ))}
